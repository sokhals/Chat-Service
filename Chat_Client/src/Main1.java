 ...
 * @author GRE
 */
public class Main1 extends JFrame implements KeyListener, Runnable, ActionListener, WindowListener {
...
try
{
                //InetAddress ip = InetAddress.getByName("GRE-PC");

                skt = new Socket("10.0.0.235", 4002);
